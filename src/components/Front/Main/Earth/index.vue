<template>
  <div id="globe" style="height:730px;width: 100%">
  </div>
</template>
<script>
...
export default {
  methods: {
    ...
    init() {
      ...
      require('echarts-gl');
      const mapChart = echarts.init(document.getElementById("globe"));
      ...
      const mapChina = echarts.init(canvas, null, {
        width: 4096,
        height: 2048
      });
      const optionChina = {
      ...
      mapChina.setOption(optionChina);
      ...
      const option = {
        ...
        globe: {
          ...
          baseTexture: require("@/assets/images/earth/earth.jpg"),//地球的纹理。支持图片路径的字符串，图片或者 Canvas 的对象
          heightTexture: require("@/assets/images/earth/height.jpg"),//地球的高度纹理
          environment: require("@/assets/images/earth/starfield.jpg"),
