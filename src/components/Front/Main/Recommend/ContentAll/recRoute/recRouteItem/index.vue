<template>
  <div>
    <div class="route-item" v-if="(recRouteList.score!=0)" @click="goRouteMsg(recRouteList.routeId)"
      ...
      <div class="route-msg">
        ...
        <div class="relative-msg">
          <div style="margin-right: 20px"><span style="color: rgb(184, 28, 34);">{{ recRouteList.commentUsers.length }}</span>&nbsp;条点评</div>
