<template>
  <div class="comment">
    <div class="comment-header">
      ...
      ></el-input>
      <div class="score" style="margin: 0 10px">
      ...
      <!-- <el-button
        type="info"
        style="height: 40px;margin-left: 20px;background-color: rgb(184, 28, 34);width"
        @click="addComment(articleId, undefined)"
        >{{ buttonText }}</el-button> -->
      <button class="commentButton" @click="addComment(articleId, undefined)">
        {{ buttonText }}
      </button>
    </div>
    <div
      ...
      <div class="first-comment">
        ...
        <div class="content">
          ...
          <div class="reply-comment" v-show="isShowSec === item._id">
            ...
            <button class="replyButton" @click="addComment(articleId, undefined)">
              回复
            </button>
          </div>
          <!-- 次级评论 -->
